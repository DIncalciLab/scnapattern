...
WorkflowScnapattern.initialise(params, log)
...
workflow SCNAPATTERN {
    ...
    // MODULE: MultiQC
    //
    workflow_summary    = WorkflowScnapattern.paramsSummaryMultiqc(workflow, summary_params)
    ch_workflow_summary = Channel.value(workflow_summary)

    methods_description    = WorkflowScnapattern.methodsDescriptionText(workflow, ch_multiqc_custom_methods_description, params)
